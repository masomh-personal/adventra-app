        ...
        <div className='w-full flex-grow bg-background text-foreground flex items-center justify-center p-6'>
            <div className='w-full max-w-3xl bg-white shadow-md rounded-lg p-8 font-body my-8'>
                ...
                <p className='mb-4 leading-relaxed'>
                    At <strong>Adventra</strong>, your privacy is important to us. This Privacy
                    Policy outlines how we collect, use, and safeguard your personal information
                    when you interact with our platform. By using Adventra, you consent to the
                ...
                <ul className='list-disc pl-6 mb-4 space-y-1'>
                    <li>
                        <strong>Account Information:</strong> Name, email, password (encrypted), and
                        profile data.
                    </li>
                    <li>
                        <strong>Adventure Preferences:</strong> Activity types, skill levels, and
                        location.
                    </li>
                    <li>
                    ...
                    <li>
                        <strong>Usage Data:</strong> Device/browser type, IP address, and app
                        interactions.
                    </li>
                </ul>
                ...
                <p className='mb-4'>
                    We do <strong>not sell</strong> your data. Limited information may be shared
                    with trusted third parties (e.g., hosting, analytics) solely to support our core
                    services.
                </p>
                ...
                <p className='mb-4'>
                    We use industry-standard encryption and security to protect your data. However,
                    no system is entirely risk-free, so we recommend using strong passwords and safe
                    online habits.
                </p>
                ...
                <p className='mb-4'>
                    Adventra is not intended for users under 18. We do not knowingly collect data
                    from children. Contact us if you believe a minor has provided data.
                </p>
                ...
                <p className='mb-4'>
                    We may update this policy as needed. Users will be notified of significant
